        <div class="row">
            ...
            <div class="col-lg-2 py-lg-5 ps-5 text-center">
                <div class="card shadow <?php if(!isset($_GET['filter_program'])) { echo 'bg-dark text-light'; } ?>">
                    <div class="card-body">
                        <?php 
            ...
            <!-- .col start -->
            <div class="col-lg-2 py-lg-5 ps-5 text-center">
                <div class="card shadow <?php if(isset($_GET['filter_program']) && $_GET['filter_program'] == 'SUP Vokasi 2020') { echo 'bg-dark text-light'; } ?>">
                    <div class="card-body">
                        <?php 
                            require_once('./config/connection.php');
            ...
            <!-- .col start -->
            <div class="col-lg-2 py-lg-5 ps-5 text-center">
                <div class="card shadow <?php if(isset($_GET['filter_program']) && $_GET['filter_program'] == 'SUP 2021') { echo 'bg-dark text-light'; } ?>">
                    <div class="card-body">
                        <?php 
                            require_once('./config/connection.php');
